...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [ __webpack_require__(89) ], __WEBPACK_AMD_DEFINE_RESULT__ = function() {}.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
...
module.exports = "<perfect-scrollbar class=scroller wheel-propagation=true wheel-speed=5 min-scrollbar-length=20> <div class=items-section> <div class=item ng-repeat=\"noteItem in $ctrl.noteDatas\"> <p>{{noteItem.note}}</p> <div class=item-action> <span>记录于：{{noteItem.play_time}}</span> <div class=icons> <span class=alert-text ng-show=noteItem.confirmingDel> 确认删除？ </span> <a href=\"\" ng-show=noteItem.confirmingDel ng-click=$ctrl.onDelete({$event:{id:noteItem.id}})> <i class=\"fa fa-check\"></i> </a> <a href=\"\" ng-show=noteItem.confirmingDel ng-click=\"noteItem.confirmingDel=false\"> <i class=\"fa fa-close\"></i> </a> <a href=\"\" ng-hide=noteItem.confirmingDel ng-click=\"noteItem.confirmingDel=true\"> <i class=\"fa fa-trash-o\"></i> </a> <a href=\"\" ng-hide=noteItem.confirmingDel ng-click=$ctrl.onEdit({$event:{target:noteItem}})> <i class=\"fa fa-edit\"></i> </a> </div> </div> </div> </div> </perfect-scrollbar>";

/***/ }),
/* 97 */
/***/ (function(module, exports) {

module.exports = "<perfect-scrollbar class=scroller wheel-propagation=true wheel-speed=5 min-scrollbar-length=20> <div class=items-section> <div class=item ng-repeat=\"qItem in $ctrl.questionDatas\" ng-class={marked:qItem.user_type}> <p>{{qItem.question}}</p> <div class=item-action> <span>提问于：{{qItem.play_time}}</span> <div class=icons> <span class=alert-text ng-show=qItem.confirmingDel> 确认删除？ </span> <a href=\"\" ng-show=qItem.confirmingDel ng-click=$ctrl.onDelete({$event:{id:qItem.id}})> <i class=\"fa fa-check\"></i> </a> <a href=\"\" ng-show=qItem.confirmingDel ng-click=\"qItem.confirmingDel=false\"> <i class=\"fa fa-close\"></i> </a> <a href=\"\" ng-hide=qItem.confirmingDel ng-if=qItem.user_type ng-click=\"qItem.confirmingDel=true\"> <i class=\"fa fa-trash-o\"></i> </a> </div> </div> <p class=answer>{{qItem.answer}}</p> </div> </div> </perfect-scrollbar>";

/***/ }),
/* 98 */
/***/ (function(module, exports) {

module.exports = "<div class=side-wrapper> <div class=head-tabs> <a href=\"\" ng-click=\"$ctrl.currentTab = '笔记'\"> <span ng-class=\"{active:$ctrl.currentTab === '笔记'}\">笔记</span> </a> <a href=\"\" ng-click=\"$ctrl.currentTab = '问题'\"> <span ng-class=\"{active:$ctrl.currentTab === '问题'}\">问答</span> </a> </div> <div class=action-section> <a href=\"\" ng-click=$ctrl.addingItem.open()> <div> <i class=\"fa fa-plus\"></i> <span>新增{{$ctrl.currentTab}}</span> </div> </a> </div> <side-bar-notes ng-show=\"$ctrl.currentTab === '笔记'\" note-datas=$ctrl.nData on-edit=$ctrl.editingNote.open($event.target) on-delete=$ctrl.deletingNote($event.id)></side-bar-notes> <side-bar-qna ng-show=\"$ctrl.currentTab === '问题'\" question-datas=$ctrl.qData on-delete=$ctrl.deleteQuestion($event.id)></side-bar-qna> <div class=add-comment ng-show=$ctrl.addingItem.isOpen> <div class=add-comment-mask ng-click=$ctrl.addingItem.close()></div> <div class=add-comment-inner> <h3>添加{{$ctrl.currentTab}} <i class=\"fa fa-close\" ng-click=$ctrl.addingItem.close()></i></h3> <div class=comment-content> <p class=error-msg ng-show=$ctrl.addingItem.errorMsg>添加{{$ctrl.currentTab}}失败，{{$ctrl.addingItem.errorMsg}}</p> <textarea ng-hide=$ctrl.addingItem.isSucceed rows=5 cols=\"\" ng-model=$ctrl.addingItem.content ng-hide=$ctrl.addingItem.isSucceed></textarea> <p class=comment-complete ng-show=$ctrl.addingItem.isSucceed> 添加{{$ctrl.currentTab}}成功！ </p> <a href=\"\" class=btn-add-comment ng-click=$ctrl.addingItem.submit() ng-hide=$ctrl.addingItem.isSucceed>添加{{$ctrl.currentTab}}</a> </div> </div> </div> <div class=add-comment ng-show=$ctrl.editingNote.isOpen> <div class=add-comment-mask ng-click=$ctrl.editingNote.close()></div> <div class=add-comment-inner> <h3>编辑{{$ctrl.currentTab}} <i class=\"fa fa-close\" ng-click=$ctrl.editingNote.close()></i></h3> <div class=comment-content> <p class=error-msg ng-show=$ctrl.editingNote.errorMsg>编辑{{$ctrl.currentTab}}失败，{{$ctrl.editingNote.errorMsg}}</p> <textarea ng-hide=$ctrl.editingNote.isSucceed rows=5 cols=\"\" ng-model=$ctrl.editingNote.content ng-hide=$ctrl.editingNote.isSucceed></textarea> <p class=comment-complete ng-show=$ctrl.editingNote.isSucceed> 编辑{{$ctrl.currentTab}}成功！ </p> <a href=\"\" class=btn-add-comment ng-click=$ctrl.editingNote.submit() ng-hide=$ctrl.editingNote.isSucceed>确认</a> </div> </div> </div> </div>";
