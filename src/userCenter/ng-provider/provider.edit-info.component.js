...
angular
  ...
  .component('providerEditInfo', {
    template: require('./provider.edit-info.temp.html'),
    controller: ['providerInfoService', '$timeout', 'Upload', function (proInfSrv, $timeoutm, $uploadSrv) {
      var that = this
      ...
      var fetchData = function () {
        proInfSrv.getUserInfos().then(function (res) {
          res = res.data
